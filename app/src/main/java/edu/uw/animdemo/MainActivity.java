...
public class MainActivity extends AppCompatActivity {
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        float y = event.getY(index) - getSupportActionBar().getHeight(); //closer to center...
...
//                view.ball.dy = (y - view.ball.cy)/Math.abs(y - view.ball.cy)*30;
            ...
            case (MotionEvent.ACTION_MOVE) : //move finger
                ...
                for (int i = 0; i < numPointers; i++) {
                    ...
                    float pointerY = event.getY(i) - getSupportActionBar().getHeight();
                    view.moveTouch(i, pointerX, pointerY);
                }
                return true;
